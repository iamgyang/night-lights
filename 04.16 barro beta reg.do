...
keep ln_WDI_ppp ln_sum_pix_bm_area ln_sum_pix_dmsp_div_area cat_iso3c cat_year year iso3c
reghdfe ln_WDI_ppp ln_sum_pix_bm_area, absorb(cat_iso3c cat_year) vce(cluster cat_iso3c)
predict ln_gdp_bm

// DMSP
reghdfe ln_WDI_ppp ln_sum_pix_dmsp_div_area, absorb(cat_iso3c cat_year) vce(cluster cat_iso3c)
predict ln_gdp_dmsp
